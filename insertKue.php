...
<form method="POST" enctype="multipart/form-data">
                <div class="isi">
                    <Input style="font-size: 25px" type="file" name="gambar" required> <br>
                    <br>
                    <input style="font-size: 25px"type="text" name="nama_kue" placeholder="isikan nama kue..." required>
                    <br><br>
                    <input style="font-size: 25px"type="text" name="jenis_kue" placeholder="isikan jenis kue..." required>
                    <br><br>
                    <input style="font-size: 25px"type="text" name="harga_kue" placeholder="isikan harga kue..." required>
                    <br><br>
                    <input style="font-size: 25px"type="text" name="stok" placeholder="isikan jumlah stok..." required>
                    <br><br>
                    <button style="font-size: 25px"type="submit" name="insertkue">Tambah</button>
                </div>
            </form>         
</table>
</div></td></tr></table>

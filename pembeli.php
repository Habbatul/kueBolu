...
<div class="isi">
     <table class="tabel"> 
            <form action="insertPembeli.php">
              <input id="menu" type="submit" id="submit" value="Tambahkan data pembeli">
  </form><br><br><h2 style="color:gray;padding-top: 10px;">Data Pembeli</h2>
                                        <tr class="tabel">
                                            <th class="tabel">ID</th>
                                            <th class="tabel">Nama Pembeli</th>
                                            <th class="tabel">Alamat Pembeli</th>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <button style="background-color: lightgray;"type="submit" onclick="return confirm('Apa anda yakin untuk hapus?');" name="deletePembeli">DELETE
                                                </button></form>
